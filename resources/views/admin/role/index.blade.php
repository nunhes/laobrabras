                ...
                <div class="p-2 w-22 h-22 flex justify-end items-center">
                    @can('role create')
                        <div class="d-print-none with-border mt-2 p-0">
                            <a href="{{ route('role.create') }}" class="text-blue-900 justify-center">
                                <!-- compoñente tooltip -->
                    ...
                    <span
                            class="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black shadow-lg">{{ __('Roles') }}</span>
                                      ...
                                      <span
                                        ...
                                        {{ __('Edit') }}</span>
                                                        ...
                                                        @can('role delete')
                                                            ...
                                                            <button class="px-2 py-2" onclick="deleteConfirm(role)">
                                                                <!-- compoñente tooltip -->
