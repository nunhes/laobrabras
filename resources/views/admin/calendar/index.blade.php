                    ...
                    <div class="flex flex-col mt-8">
                        @can('cidadan create')
                            <div class="d-print-none with-border mb-8">
                                <a href="{{ route('cidadan.create') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('Add Cidadan') }}</a>
                            </div>
                        @endcan
                        <div class="py-2">
