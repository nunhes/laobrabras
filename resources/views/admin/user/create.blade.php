            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-10">
                ...
                <div class="w-full px-6 py-4 bg-white overflow-hidden">
                    <form method="POST" action="{{ route('user.store') }}">
                        ...
                        <div class="py-2">
                            <label for="password"
                                   class="block font-medium uppercase text-sm text-gray-400{{$errors->has('password') ? ' text-red-400' : ''}}">{{ __('Password') }}</label>
                            <input id="password"
                        ...
                        <div class="py-2">
                            <label for="password_confirmation"
                                   class="block font-medium uppercase text-sm text-gray-400{{$errors->has('password') ? ' text-red-400' : ''}}">{{ __('Password Confirmation') }}</label>
