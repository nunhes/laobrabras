                               ...
                               class="text-blue-900 hover:bg-grey-200 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 justify-center">
                                ...
                                <div class="relative flex inline-flex flex-col items-center group">
                                    ...
                                    <div class="absolute bottom-0 flex flex-col items-center hidden mb-6 group-hover:flex">
                                        <span class="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black shadow-lg">{{__('Permisos') }}</span>
                                ...
                                <table class="border-collapse table-auto w-full text-sm">
                                    ...
                                    <tr>
                                        ...
                                        @canany(['user edit', 'user delete'])
                                            <th class="py-4 px-4 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light text-right">
                                                {{ __('Actions') }}
                                            </th>
                                        @endcanany
                                    </tr>
