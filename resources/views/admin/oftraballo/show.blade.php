            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="mt-3 px-6 flex items-center">
                    ...
                    <a href="{{route('oftraballo.index')}}"
                       class="no-underline hover:underline text-cyan-600 dark:text-cyan-400 mt-2">
                        <!-- compoñente tooltip -->
                        <div class="relative flex inline-flex flex-col items-center group">
                            <span class="items-center"><svg class="w-6 h-6" fill="none" stroke="currentColor"
                    ...
                    <div class="min-w-full border-b border-gray-200 shadow">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-2 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Posto') }}</label>
                                {{ $oftraballo->posto }}</td>
                            </div>
                            <div class="col-span-1 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Prazas') }}</label>
                                {{$oftraballo->numpostosofertados}}</td>
                            </div>
                            <div class="col-span-1 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Data') }}</label>
                                {{$oftraballo->data}}</td>
                            </div>
                            <div class="col-span-1 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Nº Meses') }}</label>
                                {{$oftraballo->nummeses}}</td>
                            </div>
                            <div class="col-span-1 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Empresa') }}</label>
                                {{$oftraballo->id_empresa}}</td>
                            </div>
                            <div class="col-span-1 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Observacións') }}</label>
                                {{$oftraballo->observacions}}</td>
                            </div>
                            <div class="col-span-1 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Accións FE') }}</label>
                                {{$oftraballo->accionsfe_id}}</td>
                            </div>
                            <div class="col-span-1 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Cat.Profesional') }}</label>
                                {{$oftraballo->categoriaprofesional_id}}</td>
                            </div>
                            <div class="col-span-1 ...">
                                <label for="posto" class="block font-medium uppercase text-sm text-gray-400">{{ __('Estudos mínimos') }}</label>
                                {{$oftraballo->estudiosminimos}}</td>
                            </div>
                        </div>
                    </div>
                </div>
