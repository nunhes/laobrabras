    ...
    <div class="py-4 mb-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-10">
                ...
                {{ __('Editar oferta de traballo') }}  <span class="text-cyan-600">{{ $oftraballo->id }} </span> </h2>
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="py-1 col-span-2">
                                ...
                                <input id="posto"
                                       ...
                                       type="text"
                                       name="posto"
                                       value="{{ old('posto', $oftraballo->posto) }}"/>
                            </div>
                            ...
                            <div class="py-1">
                                ...
                                <input id="data"
                                       ...
                                       type="date" name="data" value="{{ old('data', $oftraballo->data) }}"/>
                            </div>
                            ...
                            <div class="py-1">
                                ...
                                <input id="nummeses"
                                       ...
                                       type="text" name="nummeses" value="{{ old('nummeses', $oftraballo->nummeses) }}"/>
                            </div>
                            ...
                            <div class="py-1">
                                ...
                                <input id="numpostosofertados"
                                       ...
                                       type="text" name="numpostosofertados" value="{{ old('numpostosofertados', $oftraballo->numpostosofertados) }}"/>
                            </div>
                            ...
                            <div class="py-1 col-span-3">
                                ...
                                <textarea id="observacions" rows="4"
                                          class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-none border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                          placeholder="{{ old('observacions', $oftraballo->observacions) }}"></textarea>
                            </div>
                            ...
                            <div class="py-1">
                                ...
                                <input id="accionsfe_id"
                                       ...
                                       type="text" name="accionsfe_id" value="{{ old('accionsfe_id', $oftraballo->accionsfe_id) }}"/>
                            </div>
                            ...
                            <div class="py-1">
                                ...
                                <input id="id_empresa"
                                       ...
                                       type="text" name="id_empresa" value="{{ old('id_empresa', $oftraballo->id_empresa) }}"/>
                            </div>
                            ...
                            <div class="py-1">
                                ...
                                <input id="catagoriaprofesional_id"
                                       ...
                                       type="text" name="catagoriaprofesional_id" value="{{ old('catagoriaprofesional_id', $oftraballo->catagoriaprofesional_id) }}"/>
                            </div>
                            ...
                            <div class="py-1">
                                ...
                                <input id="estudiosminimos"
                                       ...
                                       type="text" name="estudiosminimos" value="{{ old('estudiosminimos', $oftraballo->estudiosminimos) }}"/>
                            </div>
                        </div><!-- end grid -->
