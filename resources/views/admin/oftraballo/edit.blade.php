                    ...
                    <form method="POST" action="{{ route('oftraballo.update', $oftraballo->id) }}">
                        ...
                        <div class="py-2 ...">
                                ...
                                <input id="data"
                                       ...
                                       type="date"
                                       name="data"
                                       value="{{ old('data', $oftraballo->data) }}"
                                />
                            </div>
                            ...
                            <div class="py-2 ...">
                                ...
                                <input id="nummeses"
                                       ...
                                       type="text"
                                       name="nummeses"
                                       value="{{ old('nummeses', $oftraballo->nummeses) }}"
                                />
                            </div>
                            ...
                            <div class="py-2 ...">
                                ...
                                <input id="numpostosofertados"
                                       ...
                                       value="{{ old('numpostosofertados', $oftraballo->numpostosofertados) }}"
                                />
                            </div>

                            <div class="py-2 col-span-6">
                                <label for="observacions"
                                       class="block text-sm font-medium uppercase text-gray-700 dark:text-gray-400">{{ __('Observacións') }}</label>
                            ...
                            <div class="py-2 ...">
                                ...
                                <input id="accionsfe_id"
                                       ...
                                       type="text"
                                       name="accionsfe_id"
                                       value="{{ old('accionsfe_id', $oftraballo->accionsfe_id) }}"
                                />
                            </div>
                            ...
                            <div class="py-2 ...">
                                ...
                                <input id="id_empresa"
                                       ...
                                       type="text"
                                       name="id_empresa"
                                       value="{{ old('id_empresa', $oftraballo->id_empresa) }}"
                                />
                            </div>
                            ...
                            <div class="py-2 ...">
                                ...
                                <input id="catagoriaprofesional_id"
                                       ...
                                       value="{{ old('catagoriaprofesional_id', $oftraballo->catagoriaprofesional_id) }}"
                                />
                            </div>
                            ...
                            <div class="py-2 ...">
                                ...
                                <input id="estudiosminimos"
                                       ...
                                       value="{{ old('estudiosminimos', $oftraballo->estudiosminimos) }}"
                                />
                            </div>
                        </div>
