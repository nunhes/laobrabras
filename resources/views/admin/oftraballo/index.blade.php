                    ...
                    <div class="flex flex-col mt-8">
                        @can('empresa create')
                            <div class="d-print-none with-border mb-8">
                                <a href="{{ route('empresa.create') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('Add Empresa') }}</a>
                            </div>
                        @endcan
                        <div class="py-2">
                                        ...
                                        <tr>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('permission.show', $empresa->id)}}" class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $empresa->name }}</a>
                                                </div>
                                            </td>
                                            @canany(['empresa edit', 'empresa delete'])
                                                <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
