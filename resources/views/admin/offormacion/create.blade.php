        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="mt-3 px-6 flex items-center">
                    <h1 class="inline-block text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight dark:text-slate-200 py-4 block sm:inline-block flex">{{ __('Crear oferta formación') }}</h1>
                ...
                <div class="w-full px-6 py-4 bg-white overflow-hidden">
                    <form method="POST" action="{{ route('offormacion.store') }}">
                        ...
                        <div class="py-2">
                            <label for="numprazas"
                                   class="block uppercase font-medium text-sm text-gray-400{{$errors->has('name') ? ' text-red-400' : ''}}">{{ __('numprazas') }}</label>
                            <input id="numprazas"
                                   class="rounded-sm shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('name') ? ' border-red-400' : ''}}"
                                   type="text"
                                   name="numprazas"
                        ...
                        <div class="py-2">
                            <label for="accionsfe_id"
                                   class="block uppercase font-medium text-sm text-gray-400{{$errors->has('name') ? ' text-red-400' : ''}}">{{ __('accionsfe_id') }}</label>
                        ...
                        <div class="py-2">
                            <label for="id_empresa"
                                   class="block uppercase font-medium text-sm text-gray-400{{$errors->has('name') ? ' text-red-400' : ''}}">{{ __('id_empresa') }}</label>
                            <input id="id_empresa"
                                   class="rounded-sm shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('name') ? ' border-red-400' : ''}}"
                                   type="text"
                                   name="id_empresa"
