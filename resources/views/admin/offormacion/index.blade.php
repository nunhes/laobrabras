        ...
        <div class="p-0 flex justify-end items-center">
          ...
          <div class="bg-gray-100">{{-- Icona de exportar a excel --}}
            <div class="d-print-none with-border mt-2 py-4 mr-3">
              <a href="{{ route('admin.exportofformacion') }}" class="justify-center">
                <!-- compoñente tooltip -->
                <div class="relative flex inline-flex flex-col items-center group">
          ...
          <div class="bg-gray-100 py-4">{{-- Icona de exportar a pdf --}}
            <div class="d-print-none with-border mt-2 p-0">
              <a href="{{ route('admin.exportpdfofformacion') }}" class="text-red-700 justify-center">
                <!-- compoñente tooltip -->
                <div class="relative flex inline-flex flex-col items-center group">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24"
...
class="no-underline hover:underline text-cyan-600">{{ $offormacion->name }}</a>
                                                </div>
                                            </td> --}}
                        ...
                        <td
                          ...
                          <div class="text-sm text-gray-900">
                            <a href="{{ route('offormacion.show', $offormacion->id) }}"
                              class="no-underline hover:underline text-cyan-600">{{ $offormacion->nome }}</a>
                          </div>
                        </td>
                        <td
                          class="border-b border-slate-100 p-1 pl-6 text-slate-500">
                          <div class="text-sm text-gray-900">
                            <a href="{{ route('offormacion.show', $offormacion->id) }}"
                              class="no-underline hover:underline text-cyan-600">{{ $offormacion->numprazas }}</a>
                          </div>
                        </td>
                        <td
                          class="border-b border-slate-100 p-1 pl-6 text-slate-500">
                          <div class="text-sm text-gray-900">
                            <a href="{{ route('offormacion.show', $offormacion->id) }}"
                              class="no-underline hover:underline text-cyan-600">{{ $offormacion->datadende }}</a>
                          </div>
                        </td>
                        <td
                          class="border-b border-slate-100 p-1 pl-6 text-slate-500">
                          <div class="text-sm text-gray-900">
                            <a href="{{ route('offormacion.show', $offormacion->id) }}"
                              class="no-underline hover:underline text-cyan-600">{{ $offormacion->dataata }}</a>
                          </div>
                        </td>
                        <td
                          class="border-b border-slate-100 p-1 pl-6 text-slate-500">
                          <div class="text-sm text-gray-900">
                            <a href="{{ route('offormacion.show', $offormacion->id) }}"
                              class="no-underline hover:underline text-cyan-600">{{ $offormacion->numhoras }}</a>
                          </div>
                        </td>
                        ...
                        <td
                          ...
                          <div class="text-sm text-gray-900">
                            <a href="{{ route('offormacion.show', $offormacion->id) }}"
                              class="no-underline hover:underline text-cyan-600">{{ $offormacion->tipo }}</a>
                          </div>
                        </td>

                        @canany(['offormacion edit', 'offormacion delete'])
                          <td class="border-b border-slate-100 p-1 pl-6 pr-3 text-slate-500 text-right">
