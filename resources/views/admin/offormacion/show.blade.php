          ...
          <div class="p-0 flex justify-end items-center">
                    @can('offormacion create')
                        <div class="d-print-none with-border mt-2 py-4">
                            <a href="{{ route('offormacion.create') }}" class="text-gray-500 justify-center">
                                <!-- compoñente tooltip -->
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-10">
                <div class="flex items-center mt-3">
                    <div class="w-1/2 p-2">
                      ...
                      {{  __('Oferta de formacion') }}  <span class="text-cyan-600">{{ $offormacion->id }} </span> </h2>
                    ...
                    <div class="min-w-full">
                        <div class="grid grid-cols-4 gap-4 mb-10">
                            <div class="col-span-2 border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Posto</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900">{{ $offormacion->nome }}</div>
                            </div>
                            <div class="border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Dende o</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900">{{ $offormacion->datadende }}</div>
                            </div>
                            <div class="border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Ata o</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900">{{ $offormacion->dataata }}</div>
                            </div>
                            <div class="col-span-2 border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Lugar</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900">{{ $offormacion->lugar }}</div>
                            </div>
                            <div class="border-b border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Nº horas</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900">{{ $offormacion->numhoras }}</div>
                            </div>
                            <div class="border-b border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Prazas</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900">{{ $offormacion->numprazas }}</div>
                            </div>
                            <div class="col-span-2 border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Tipo</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900">{{ $offormacion->tipo }}</div>
                            </div>
                            <div class="col-span-2 border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Empresa</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900"><a href="{{ route('empresa.show', $offormacion->id_empresa) }}"
                                                                                    class="px-2 py-2 text-cyan-600">{{ $offormacion->id_empresa }}</a></div>
                            </div>
                            <div class="col-span-2 border-b border-gray-200 shadow">
                                <label class="block uppercase text-sm text-slate-400 py-1 px-4">Publicada</label>
                                <div class="py-2 px-4 bg-gray-100 text-blue-900">{{ $offormacion->created_at }}</div>
                            </div>
                        </div><!-- end grid-->
                    </div>
                </div>
