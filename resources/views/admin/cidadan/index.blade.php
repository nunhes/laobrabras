...
class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $cidadan->nome }}</a>
                                            ...
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-1 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('cidadan.show', $cidadan->id)}}"
                                                       class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $cidadan->apel1 }}</a>
                                                </div>
                                            </td>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-1 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('cidadan.show', $cidadan->id)}}"
                                                       class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $cidadan->nif }}</a>
                                                </div>
                                            </td>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-1 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('cidadan.show', $cidadan->id)}}"
                                                       class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $cidadan->codpostal }}</a>
                                                </div>
                                            </td>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-1 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('cidadan.show', $cidadan->id)}}"
                                                       class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $cidadan->email }}</a>
                                                </div>
                                            </td>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-1 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('cidadan.show', $cidadan->id)}}"
                                                       class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $cidadan->tfno1 }}</a>
                                                </div>
                                            </td>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-1 pl-8 text-slate-500 dark:text-slate-400">
                                                <div class="text-sm text-gray-900">
                                                    <a href="{{route('cidadan.show', $cidadan->id)}}"
                                                       class="no-underline hover:underline text-cyan-600 dark:text-cyan-400">{{ $cidadan->datanacemento }}</a>
                                            ...
                                            @canany(['cidadan edit', 'cidadan delete'])
                                                <td class="border-b border-slate-100 dark:border-slate-700 p-1 pl-8 text-slate-500 dark:text-slate-400">
                                                    ...
                                                    <form action="{{ route('cidadan.destroy', $cidadan->id) }}"
